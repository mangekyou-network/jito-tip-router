...
impl DistributeNcnOperatorRewards {
  pub fn instruction(&self, args: DistributeNcnOperatorRewardsInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DistributeNcnOperatorRewardsInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = DistributeNcnOperatorRewardsInstructionData::new().try_to_vec().unwrap();
...
impl<'a, 'b> DistributeNcnOperatorRewardsCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn operator(&mut self, operator: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn operator_ata(&mut self, operator_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
