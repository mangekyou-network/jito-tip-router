...
impl AdminRegisterStMint {
  pub fn instruction(&self, args: AdminRegisterStMintInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AdminRegisterStMintInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = AdminRegisterStMintInstructionData::new().try_to_vec().unwrap();
    ...
    let accounts = AdminRegisterStMint {
          ...
          let args = AdminRegisterStMintInstructionArgs {
                                                              ncn_fee_group: self.ncn_fee_group.clone().expect("ncn_fee_group is not set"),
                                                                  reward_multiplier_bps: self.reward_multiplier_bps.clone().expect("reward_multiplier_bps is not set"),
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = AdminRegisterStMintInstructionArgs {
                                                              ncn_fee_group: self.instruction.ncn_fee_group.clone().expect("ncn_fee_group is not set"),
                                                                  reward_multiplier_bps: self.instruction.reward_multiplier_bps.clone().expect("reward_multiplier_bps is not set"),
