...
impl CloseEpochAccount {
  pub fn instruction(&self, args: CloseEpochAccountInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CloseEpochAccountInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = CloseEpochAccountInstructionData::new().try_to_vec().unwrap();
...
impl CloseEpochAccountBuilder {
  pub fn new() -> Self {
    ...
    pub fn ncn(&mut self, ncn: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn account_to_close(&mut self, account_to_close: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
    pub fn system_program(&mut self, system_program: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            /// `[optional account]`
#[inline(always)]
    pub fn receiver_to_close(&mut self, receiver_to_close: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
...
impl<'a, 'b> CloseEpochAccountCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn ncn(&mut self, ncn: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn account_to_close(&mut self, account_to_close: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn account_payer(&mut self, account_payer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn dao_wallet(&mut self, dao_wallet: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn system_program(&mut self, system_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn receiver_to_close(&mut self, receiver_to_close: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          account_to_close: self.instruction.account_to_close.expect("account_to_close is not set"),
