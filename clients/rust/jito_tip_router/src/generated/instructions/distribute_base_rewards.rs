...
impl DistributeBaseRewards {
  pub fn instruction(&self, args: DistributeBaseRewardsInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DistributeBaseRewardsInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = DistributeBaseRewardsInstructionData::new().try_to_vec().unwrap();
...
impl DistributeBaseRewardsBuilder {
  pub fn new() -> Self {
    ...
    pub fn ncn(&mut self, ncn: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn base_reward_router(&mut self, base_reward_router: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.base_reward_router = Some(base_reward_router);
                    self
    }
            #[inline(always)]
    pub fn base_reward_receiver(&mut self, base_reward_receiver: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.base_reward_receiver = Some(base_reward_receiver);
                    self
    }
            #[inline(always)]
    pub fn base_fee_wallet(&mut self, base_fee_wallet: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.base_fee_wallet = Some(base_fee_wallet);
                    self
    }
            #[inline(always)]
    pub fn base_fee_wallet_ata(&mut self, base_fee_wallet_ata: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DistributeBaseRewards {
                              epoch_state: self.epoch_state.expect("epoch_state is not set"),
                                        ...
                                        base_reward_router: self.base_reward_router.expect("base_reward_router is not set"),
                                        base_reward_receiver: self.base_reward_receiver.expect("base_reward_receiver is not set"),
                                        base_fee_wallet: self.base_fee_wallet.expect("base_fee_wallet is not set"),
                                        base_fee_wallet_ata: self.base_fee_wallet_ata.expect("base_fee_wallet_ata is not set"),
          ...
          let args = DistributeBaseRewardsInstructionArgs {
                                                              base_fee_group: self.base_fee_group.clone().expect("base_fee_group is not set"),
...
impl<'a, 'b> DistributeBaseRewardsCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn ncn(&mut self, ncn: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn base_reward_router(&mut self, base_reward_router: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.base_reward_router = Some(base_reward_router);
                    self
    }
      #[inline(always)]
    pub fn base_reward_receiver(&mut self, base_reward_receiver: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.base_reward_receiver = Some(base_reward_receiver);
                    self
    }
      #[inline(always)]
    pub fn base_fee_wallet(&mut self, base_fee_wallet: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.base_fee_wallet = Some(base_fee_wallet);
                    self
    }
      #[inline(always)]
    pub fn base_fee_wallet_ata(&mut self, base_fee_wallet_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = DistributeBaseRewardsInstructionArgs {
                                                              base_fee_group: self.instruction.base_fee_group.clone().expect("base_fee_group is not set"),
        ...
        __program: self.instruction.__program,
          ...
          base_reward_router: self.instruction.base_reward_router.expect("base_reward_router is not set"),
                  
          base_reward_receiver: self.instruction.base_reward_receiver.expect("base_reward_receiver is not set"),
                  
          base_fee_wallet: self.instruction.base_fee_wallet.expect("base_fee_wallet is not set"),
                  
          base_fee_wallet_ata: self.instruction.base_fee_wallet_ata.expect("base_fee_wallet_ata is not set"),
