...
impl InitializeConfigBuilder {
  pub fn new() -> Self {
    ...
    pub fn ncn_admin(&mut self, ncn_admin: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn tie_breaker_admin(&mut self, tie_breaker_admin: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = InitializeConfig {
                              config: self.config.expect("config is not set"),
                                        ...
                                        tie_breaker_admin: self.tie_breaker_admin.expect("tie_breaker_admin is not set"),
          ...
          let args = InitializeConfigInstructionArgs {
                                                              block_engine_fee_bps: self.block_engine_fee_bps.clone().expect("block_engine_fee_bps is not set"),
                                                                  dao_fee_bps: self.dao_fee_bps.clone().expect("dao_fee_bps is not set"),
                                                                  default_ncn_fee_bps: self.default_ncn_fee_bps.clone().expect("default_ncn_fee_bps is not set"),
                                                                  epochs_before_stall: self.epochs_before_stall.clone().expect("epochs_before_stall is not set"),
                                                                  epochs_after_consensus_before_close: self.epochs_after_consensus_before_close.clone().expect("epochs_after_consensus_before_close is not set"),
                                                                  valid_slots_after_consensus: self.valid_slots_after_consensus.clone().expect("valid_slots_after_consensus is not set"),
                                    };
...
impl<'a, 'b> InitializeConfigCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn ncn(&mut self, ncn: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn fee_wallet(&mut self, fee_wallet: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn ncn_admin(&mut self, ncn_admin: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn tie_breaker_admin(&mut self, tie_breaker_admin: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = InitializeConfigInstructionArgs {
                                                              block_engine_fee_bps: self.instruction.block_engine_fee_bps.clone().expect("block_engine_fee_bps is not set"),
                                                                  dao_fee_bps: self.instruction.dao_fee_bps.clone().expect("dao_fee_bps is not set"),
                                                                  default_ncn_fee_bps: self.instruction.default_ncn_fee_bps.clone().expect("default_ncn_fee_bps is not set"),
                                                                  epochs_before_stall: self.instruction.epochs_before_stall.clone().expect("epochs_before_stall is not set"),
                                                                  epochs_after_consensus_before_close: self.instruction.epochs_after_consensus_before_close.clone().expect("epochs_after_consensus_before_close is not set"),
                                                                  valid_slots_after_consensus: self.instruction.valid_slots_after_consensus.clone().expect("valid_slots_after_consensus is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          tie_breaker_admin: self.instruction.tie_breaker_admin.expect("tie_breaker_admin is not set"),
