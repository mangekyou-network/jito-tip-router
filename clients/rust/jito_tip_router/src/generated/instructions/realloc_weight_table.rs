...
impl ReallocWeightTable {
  pub fn instruction(&self, args: ReallocWeightTableInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ReallocWeightTableInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = ReallocWeightTableInstructionData::new().try_to_vec().unwrap();
