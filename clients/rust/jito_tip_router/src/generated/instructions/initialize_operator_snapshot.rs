...
impl InitializeOperatorSnapshot {
  pub fn instruction(&self, args: InitializeOperatorSnapshotInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeOperatorSnapshotInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
>>>>>>> cf534adfb33ea5afa9eccb11b35199f5b149fea2
    ...
    let mut data = InitializeOperatorSnapshotInstructionData::new().try_to_vec().unwrap();
